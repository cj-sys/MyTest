	...
	<div class="container">
		...
		<div class="col-lg-4"></div>
			<div class="jumbotron" style="padding-top: 20px;">
				...
				<!-- 입력받은 데이터, 각각의 name에 적힌 이름으로 조인액션페이지로 넘어간다. -->
					...
					<div class="form-group">
						<input type="email" class="form-control" placeholder="메일" name="userEmail" maxlength="20">
					</div>
					<input type="submit" class="btn btn-primary form-control" value="회원가입">
					<!-- 타입이 서브밋,, 완료... 버튼을 누르면 입력받은 데이터가 조인액션페이지로 넘어간다. -->
				</form>
			</div>
	</div>
	<!-- 애니메이션을 담당하게될 js를 참조-->	
